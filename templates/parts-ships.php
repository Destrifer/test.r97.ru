...
require '_new-codebase/front/templates/main/parts/parts-ships/parts-ships.php';
...
if (!empty(App::$URLParams['ajax'])) {
    ...
    switch (App::$URLParams['ajax']) {
        ...
        case 'get-ships':
            $filter = datatableFilter(App::$URLParams, Ships::getCols());
            $response = datatableResponse(Ships::getShips($filter), $filter, Ships::getFilterCnt($filter), Ships::getTotalCnt());
            break;
...
<head>
    <meta charset="utf-8">
    <title>Список отправок - Панель управления</title>
...
<body>
    ...
    <main class="wrapper" style="max-width: 1920px">
        ...
        <h2 class="layout__mb_md">Список отправок</h2>
        ...
        <section class="layout__mb_lg">
            ...
            <table id="datatable" class="display">
                <?php tableHeadHTML(Ships::getCols()); ?>
            </table>
    ...
    <script src="/_new-codebase/front/modules/parts-ships/parts-ships.js?v=<?= VER; ?>"></script>
