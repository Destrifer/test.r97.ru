...
(function($){
	...
	jQuery.extend({
		  ...
		  alertx: function(title,msg) {
				...
				dialog.show({
					'title':title,
					'content':'<div class="form-list"><br><p class="center">'+msg+'</p><br><br><div class="center"><a class="btn btn-blue js-yes-btn" href="javascript:void(0);">Уверен</a></div><br /></div>',
		  ...
		  confirmx: function(title,msg,yesCallback,cancleCallback) {
			  ...
			  var options = {
				  'title':title,
				  'content':'<div class="form-list"><br><p class="center">'+msg+'</p><br><br><div class="center"><a class="btn btn-blue js-yes-btn" href="javascript:void(0);">Уверен</a><a class="btn btn-gray btn-h30 js-cancle-btn" href="javascript:void(0);">Отменить</a></div><br /></div>',
				  'ctnWrapClass':'elastic-pupop-sl'
			  };
