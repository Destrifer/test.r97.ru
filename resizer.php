...
define ('PNG_IS_TRANSPARENT', TRUE);																	// Version of this script
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './img_cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
